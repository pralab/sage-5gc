...
def merge_benign_samples(dataset_source_path: str,
...
if __name__ == "__main__":
    merge_benign_samples(
        dataset_source_path="data/cleaned_datasets/dataset_2_cleaned.csv",
        dataset_target_path="data/cleaned_datasets/dataset_1_cleaned.csv",
        output_path="data/cleaned_datasets/dataset_training_benign.csv"
    )
