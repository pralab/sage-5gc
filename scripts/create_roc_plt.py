...
- It saves the ROC curve comparison plot to a result/roc_curve/.
"""
...
# function to create ROC curve comparison plot using logarithmic scale for multiple models
def create_roc_curve_comparison_plot(model_paths: list, model_names: list, test_data_path: str, output_dir: str):
...
if __name__ == "__main__":
    ...
    create_roc_curve_comparison_plot(model_paths, model_names, test_data_path, output_dir)
